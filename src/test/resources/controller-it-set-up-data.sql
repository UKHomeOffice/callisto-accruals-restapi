DO ' DECLARE
    ...
    agreement1_end_date CONSTANT DATE := ''2022-04-11'';
    agreement2_id VARCHAR := gen_random_uuid();
    agreement2_start_date CONSTANT DATE := ''2022-04-12'';
    agreement2_end_date CONSTANT DATE := ''2022-04-14'';
BEGIN
    ...
    VALUES (gen_random_uuid(),
            ...
            0,
            person_id,
            ''{"total": 10, "timeEntries": {"10000000-0000-0000-0000-000000000010": 10}}'');
    ...
    VALUES (gen_random_uuid(),
        ...
        0,
        person_id,
        ''{"total": 11, "timeEntries": {"10000000-0000-0000-0000-000000000010": 10,
                                        "10000000-0000-0000-0000-000000000111": 111,
    ...
    VALUES (gen_random_uuid(),
        ...
        0,
        person_id,
        ''{"total": 12, "timeEntries": {"10000000-0000-0000-0000-000000000111": 111,
    ...
    VALUES (gen_random_uuid(),
        ...
        0,
        person_id,
        ''{"total": 13, "timeEntries": {"10000000-0000-0000-0000-000000000013": 13}}'');
    ...
    VALUES (gen_random_uuid(),
        ...
        0,
        person_id,
        ''{"total": 14, "timeEntries": {"10000000-0000-0000-0000-000000000014": 14}}'');
